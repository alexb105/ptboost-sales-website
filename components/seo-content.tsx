 ...
 * Hidden from visual display but accessible to search engines and AI
...
export function SEOContent() {
  return (
    <div className="sr-only" aria-hidden="true">
      ...
      <h3>Who We Serve</h3>
      <p>
        We serve UK personal trainers at early to mid stages of growth. If you want a credible online presence without agency fees or technical hassle, this is for you.
      </p>
      ...
      <p>
        Your site is optimised for local search so nearby clients can find you on Google when they look for a personal trainer in their area.
      </p>
      ...
      <p>
        Built for UK personal trainers who want to look legit, save time on tech, and book more quality clients.
      </p>

      <h3>Service Areas</h3>
      <p>
        We serve trainers across the United Kingdom.
      </p>

      <h3>Key Features</h3>
      <p>
        Psychology-led design, mobile-first builds, hosting and maintenance included, lead capture, 7-day launch, fast performance, and an AI editor for easy management.
      </p>
