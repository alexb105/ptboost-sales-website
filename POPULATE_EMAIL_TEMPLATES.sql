-- This script populates the email_templates table with the hardcoded HTML content
-- from the email route files, converting JavaScript template literals to template variable format

-- Helper function to convert template literals to template variables
-- This is done manually in the SQL below
...
SET html_content = '
              ...
              <div class="content">
                ...
                <div class="password-card">
                  ...
                  <div class="password-display">
                    <code>{subscriptionPassword}</code>
                  </div>
                  <p class="password-note">
                    💡 Use this password to cancel, update payment methods, or view invoices
                  </p>
                  <a style="color: white;" href="{siteUrl}/account" class="button">
                    Manage Your Account →
                  </a>
                </div>
                ...
                <div class="section">
                  ...
                  <div class="details-grid">
                    ...
                    <div class="detail-item">
                      ...
                      <div class="detail-value">{preferredColors}</div>
                    </div>
                    {/if_preferredColors}
                  </div>
                </div>
      ...
      '
WHERE template_key = 'customer_booking_confirmation';

-- Note: Due to SQL string length limitations, I'll create a separate script file
-- that uses a Node.js script to populate the templates via the API or direct database connection
-- This is more practical for large HTML content
